...
#include "periphery/mavlink_serial/mavlink/include/mavlink/v2.0/common/testsuite.h"
#include "periphery/mavlink_serial/mavlink/include/mavlink/v2.0/uAvionix/testsuite.h"
#include "periphery/mavlink_serial/mavlink/include/mavlink/v2.0/icarous/testsuite.h"


static void mavlink_test_modem_rssi(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MODEM_RSSI >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        ...
        uint16_t i;
    mavlink_modem_rssi_t packet_in = {
        17235,17339,17
    };
    mavlink_modem_rssi_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.rssi = packet_in.rssi;
        packet1.lte_rssi = packet_in.lte_rssi;
        packet1.net_type = packet_in.net_type;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MODEM_RSSI_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MODEM_RSSI_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_modem_rssi_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_modem_rssi_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_modem_rssi_pack(system_id, component_id, &msg , packet1.rssi , packet1.lte_rssi , packet1.net_type );
    mavlink_msg_modem_rssi_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_modem_rssi_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rssi , packet1.lte_rssi , packet1.net_type );
    mavlink_msg_modem_rssi_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_modem_rssi_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_modem_rssi_send(MAVLINK_COMM_1 , packet1.rssi , packet1.lte_rssi , packet1.net_type );
    mavlink_msg_modem_rssi_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_video_stream_bitrate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VIDEO_STREAM_BITRATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_video_stream_bitrate_t packet_in = {
        17.0
    };
    mavlink_video_stream_bitrate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VIDEO_STREAM_BITRATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VIDEO_STREAM_BITRATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_stream_bitrate_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_video_stream_bitrate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_stream_bitrate_pack(system_id, component_id, &msg , packet1.Bitrate );
    mavlink_msg_video_stream_bitrate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_stream_bitrate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Bitrate );
    mavlink_msg_video_stream_bitrate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_video_stream_bitrate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_video_stream_bitrate_send(MAVLINK_COMM_1 , packet1.Bitrate );
    mavlink_msg_video_stream_bitrate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
{
    mavlink_test_modem_rssi(system_id, component_id, last_msg);
    mavlink_test_video_stream_bitrate(system_id, component_id, last_msg);
