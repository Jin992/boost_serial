...
typedef enum MAV_COMPONENT
{
   ...
   MAV_COMP_ID_OSD=157, /* On Screen Display (OSD) devices for camera links. | */
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_LOGGING_STOP=2511, /* Request to stop streaming logger data over MAVLink |Reserved (set to 0)| Reserved (set to 0)| Reserved (set to 0)| Reserved (set to 0)| Reserved (set to 0)| et to 0)| Reserved (set to 0)|  */
...
{
   CAMERA_CAP_FLAGS_CAPTURE_VIDEO=1, /* Camera is able to record camera | */
   ...
   CAMERA_CAP_FLAGS_CAN_CAPTURE_IMAGE_IN_VIDEO_MODE=8, /* Camera can capture images while in camera mode | */
   ...
   CAMERA_CAP_FLAGS_HAS_VIDEO_STREAM=256, /* Camera has camera streaming capabilities (use MAV_CMD_REQUEST_VIDEO_STREAM_INFORMATION for camera streaming info) | */
...
typedef enum CAMERA_MODE
{
   ...
   CAMERA_MODE_VIDEO=1, /* Camera is in camera capture mode. | */
